...
class WordpieceTokenizer(object):
  ...
  def __init__(self, vocab, return_org, unk_token="[UNK]", max_input_chars_per_word=200):
    self.vocab = vocab
...
if __name__ == '__main__':
  pre = FullTokenizer(r'C:\Users\Windows\Documents\GitHub\predictor\reuters_news\reuters_news_processer\vocab.csv')
  print(pre.convert_tokens_to_ids(pre.tokenize('你好 嘉陵')))
