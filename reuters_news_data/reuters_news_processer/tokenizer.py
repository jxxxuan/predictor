...
if __name__ == '__main__':
  pre = FullTokenizer(r'C:\Users\Windows\Documents\GitHub\predictor\reuters_news_data\vocab.csv')
  print(pre.convert_tokens_to_ids(pre.tokenize('hello world ksdc bye')))
